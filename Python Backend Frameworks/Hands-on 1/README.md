...
Model -> Database layer (same as MVC Model). View -> Contains business logic (acts like the Controller in MVC). Template -> Presentation layer (acts like the View in MVC).
